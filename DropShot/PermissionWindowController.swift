...
enum PermissionWindowStep {
    ...
    var bodyText: String {
        ...
        case .openSettings:
            return "DropShot still needs Screen Recording access before Capture can start. Turn it on in System Settings > Privacy & Security > Screen Recording, then try Capture again."
        }
    }
